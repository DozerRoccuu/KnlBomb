...
def inst_logs():
	...
	try:
		if platform == "linux" or platform == "linux2":
			...
			print(colored("Пожалуйста отправьте поочередно эти 2 файла в наш чат телеграм", "green"), colored("https://t.me/KnlXDChat", "cyan"))
			print("")
...
def start_input():
	...
	if pr != None:
		while True:
			...
			print("└"+colored("Общедоступный прокси используют все пользователи KnlBomb", "cyan"))
			print()
